...
public enum ExceptionResult {
    ...
    ALREADY_JOIN_MBSP(HttpStatus.BAD_REQUEST, "이미 가입한 멤버십입니다."),
    ...
    NOT_FOUND_MBSP(HttpStatus.BAD_REQUEST, "멤버십 또는 멤버십과 관련된 정보를 찾을 수 없습니다."),
    NOT_FOUND_ACNT(HttpStatus.BAD_REQUEST, "존재하지 않는 회원입니다."),
    NOT_FOUND_MSP_INFO(HttpStatus.BAD_REQUEST, "해당 멤버십은 존재하지 않습니다."),
    NOT_JOIN_MBSP(HttpStatus.BAD_REQUEST, "가입하지 않은 멤버십입니다."),
